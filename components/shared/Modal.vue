...
<template>
    <div class="moda w-screen h-screen">
            <div @click="closeModal" class="cursor-pointer moda-close absolute">
            ...
            <h2 class="text-2xl mb-6 text-white">Proximamente</h2>
    </div>
</template>
